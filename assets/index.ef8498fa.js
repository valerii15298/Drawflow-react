...
`,re=S.button`
  ...
  color: #fff;
  border-radius: 4px;
`,ie=()=>{const e=A((e=>V(e).editLock)),t=j();return k.createElement(se,null,!e&&k.createElement(re,null,"Clear"),k.createElement(re,{onClick:()=>t(Y.setEditLock(!e))},e?"UnLock":"Lock"))},le=S.div`
  position: absolute;
  bottom: 10px;
  right: 10px;
  padding: 5px 10px;
...
`,pe=S.path`
  ...
  ${({selected:e})=>e&&M`
      ...
      stroke: red;
    `};
`,he=e=>{const{id:t,d:o}=e,n=(e=>A(P.exports.useMemo((()=>ce((t=>{if(void 0===e)return!1;const o=V(t).select;return"path"===(null==o?void 0:o.type)&&o.selectId===e}),(e=>e))),[e])))(t),s=j();return k.createElement(ue,null,k.createElement(pe,{selected:n,d:o,onMouseDown:e=>{void 0!==t&&(e.stopPropagation(),s(Y.select({type:"path",selectId:t})))}}))},ge=()=>{var e;console.log("Render new Path");const t=null!=(e=A(P.exports.useMemo((()=>ce((e=>{const t=V(e);if(!t.select||t.select.type!==r.out||!t.newPathDirection)return void console.error("Cannot draw new path!");const o=t.ports[t.select.selectId];if(!o)return void console.error("No start port in newPath");const n=o.pos;if(!e.canvas)return void console.error("Canvas shape is not available");const{clientX:s,clientY:i}=t.newPathDirection,l=F(s,i,t.config.zoom.value,e.canvas);return U(n,l)}),(e=>e))),[])))?e:"";return k.createElement(he,{d:t})},fe=S.div`
  max-height: 100%;
  overflow: hidden;
`,me=e=>k.createElement(fe,null,JSON.stringify(e,null,2)),ve=100,be=60,we=S.div`
  width: 15px;
  height: 15px;
  border-radius: 60px;
...
`,Ie=S(ye)`
  ...
  ${({isSub:e})=>e&&M`
      ...
      top: 50%;
    `}
`,Se={[r.in]:[Ie],[r.out]:[xe,Ee]},ke=e=>{const{nodeId:t,portId:o,type:n}=e,s=j(),r=(i=e,A(P.exports.useMemo((()=>ce((e=>{const{portToConnect:t}=V(e);if(void 0===t)return!1;const o=JSON.parse(JSON.stringify(t));return delete o.pos,m.isEqual(i,o)}),(e=>e))),[i])));var i;const l=(a=t,A(P.exports.useMemo((()=>ce((e=>V(e).drawflow[a].isSub),(e=>e))),[a])));var a;const d=Se[n][o-1];return k.createElement(d,{isSub:l,onMouseDown:e=>{e.stopPropagation(),s(Y.selectPort({type:n,nodeId:t,portId:o}))},onMouseUp:e=>{s(Y.portMouseUp({nodeId:t,portId:o,PortType:n}))}},k.createElement(we,{visible:r}))},Ce=e=>{const{id:t,port:o,type:n}=e;let s=[];for(let r=1;r<=o[n];r++)s.push(k.createElement(ke,{key:r,nodeId:t,portId:r,type:n}));return k.createElement("div",{className:`${n}puts`},s)},Ne=S.div`
...
`,Oe=S.div`
  ...
  height: 100%;
  position: relative;
`,Xe=(e,t,o,n)=>{var s;const[r,i]=(null==(s=getComputedStyle(e).transform.match(/^matrix\((.+)\)$/))?void 0:s[1].split(",").slice(-2).map(Number))||[0,0];e.style.transform=`translate(${r+t}px, ${i+o}px) scale(${n})`},ze=()=>{console.log("Render Drawflow");const{config:{zoom:e},newPathDirection:t,canvasDrag:o}=A(P.exports.useMemo((()=>ce((e=>{const t=V(e),{config:{zoom:o},newPathDirection:n,canvasDrag:s}=t;return{config:{zoom:o},newPathDirection:n,canvasDrag:s}}),(e=>e))),[])),n=j();P.exports.useEffect((()=>{n(oe())}),[n]);const s=P.exports.useRef(null);return P.exports.useEffect((()=>{const{current:t}=s;t&&Xe(t,0,0,e.value)}),[o,e.value]),P.exports.useEffect((()=>{const{current:e}=s;if(e){const t=e.getBoundingClientRect(),o={x:t.x,y:t.y,width:e.clientWidth,height:e.clientHeight};n(_(o))}}),[n,s]),k.createElement(Le,{className:"drawflow",tabIndex:0,onKeyDownCapture:e=>{"Delete"===e.key&&(n(Y.deletePath()),n(Y.deleteNode())),e.ctrlKey&&"c"===e.key&&n(Y.copyNode()),e.ctrlKey&&"v"===e.key&&n(Z())},onMouseDown:e=>{n(Y.canvasDrag(!0)),n(Y.unSelect())},onMouseUp:()=>n(Y.canvasMouseUp()),onMouseMove:t=>{const{clientX:r,clientY:i,movementX:l,movementY:a}=t,{current:d}=s;o&&d&&Xe(d,l,a,e.value),n(Y.canvasMouseMove({clientX:r,clientY:i,movementX:l,movementY:a}))},onMouseEnter:e=>{const{clientX:t,clientY:o}=e;console.log("enter"),n(H({clientX:t,clientY:o}))}},k.createElement(ie,null),k.createElement(de,null),k.createElement(Oe,{ref:s,className:"drawflow",style:{}},k.createElement(Me,null),k.createElement(Te,null),t&&k.createElement(ge,null)))};const We=e=>k.createElement("svg",f(g({},e),{viewBox:"0 0 24 24"}),k.createElement("path",{fill:"none",stroke:"#303c42",strokeLinecap:"round",strokeLinejoin:"round",d:"M21,1.5H3A1.5,1.5,0,0,0,1.5,3V22.5l5-5H21A1.5,1.5,0,0,0,22.5,16V3A1.5,1.5,0,0,0,21,1.5Z"})),Ye=e=>k.createElement("svg",f(g({},e),{viewBox:"0 0 16 16",fill:"none"}),k.createElement("path",{d:"M7.33333 12.6667C10.2789 12.6667 12.6667 10.2789 12.6667 7.33333C12.6667 4.38781 10.2789 2 7.33333 2C4.38781 2 2 4.38781 2 7.33333C2 10.2789 4.38781 12.6667 7.33333 12.6667Z",stroke:"#A5A5B8",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),k.createElement("path",{d:"M14.0016 13.9996L11.1016 11.0996",stroke:"#A5A5B8",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})),$e=e=>k.createElement("svg",f(g({},e),{viewBox:"0 0 10 14",fill:"none"}),k.createElement("path",{d:"M8 2L2.18437 6.84636C2.08842 6.92631 2.08842 7.07369 2.18437 7.15364L8 12",stroke:"#393C44",strokeWidth:"2.5",strokeLinecap:"round"})),Ve=e=>k.createElement("svg",f(g({},e),{viewBox:"0 0 1792 1792"}),k.createElement("path",{fill:"#217CE8",d:"M1011 1376q0 13-10 23l-50 50q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l466-466q10-10 23-10t23 10l50 50q10 10 10 23t-10 23l-393 393 393 393q10 10 10 23zm384 0q0 13-10 23l-50 50q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l466-466q10-10 23-10t23 10l50 50q10 10 10 23t-10 23l-393 393 393 393q10 10 10 23z"})),je=S.div`
  display: grid;
  place-items: center;
  padding: 0.5em;
...
`,nt=M`
  ...
  font-size: 14px;
  border: 1px solid #e8e8ef;
`,st=S.div``,rt=S.button`
  ${nt}
  :focus {
    background-color: #fbfbfb;
    font-weight: bold;
  }
`,it=S.div``,lt=S.button`
  margin: 0 10px;
...
`,pt=S.button`
  ...
  ${nt}
  color: white;
`,ht=()=>k.createElement(tt,null,k.createElement(ot,null,k.createElement(lt,null,k.createElement($e,{height:14})),k.createElement(at,null,k.createElement(dt,null,"Flow name"),k.createElement(ct,null,"Flow description"))),k.createElement(st,null,k.createElement(rt,null,"Diagram view"),k.createElement(rt,null,"Code editor"),k.createElement(rt,null,"Active"),k.createElement(rt,null,"Settings")),k.createElement(it,null,k.createElement(ut,null,"Delete flow"),k.createElement(pt,null,"Save flow"))),gt=S.div`
  display: flex;
  height: 40px;
`;function ft(){var e;console.log("Render App");const t=j(),o=null==(e=A((e=>e.sidebarVisible)))||e;return k.createElement("div",{className:"App"},k.createElement(ht,null),k.createElement("main",null,k.createElement(et,null),k.createElement("div",{className:"flow"},k.createElement(gt,null,!o&&k.createElement(Qe,null),k.createElement("button",{onClick:()=>t(oe())},"Fetch flow version"),k.createElement("button",{onClick:()=>t(J(0))},"Version 1"),k.createElement("button",{onClick:()=>t(J(1))},"Version 2"),k.createElement("button",{onClick:()=>t(J(2))},"Version 3")),k.createElement(ze,null))))}D.render(k.createElement(P.exports.StrictMode,null,k.createElement(T,{store:ne},k.createElement(ft,null))),document.getElementById("root"));
