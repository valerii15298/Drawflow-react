...
`,yt=D.button`
  ...
  padding: 0;
`,Et=({setSearchWord:e})=>{const t=K();return N.createElement(xt,null,N.createElement(vt,null,N.createElement(Q,null)),N.createElement(wt,{type:"text",placeholder:"Search templates",onChange:t=>{e(t.target.value)}}),N.createElement(yt,{onClick:()=>t(Le({windowConfig:{sideId:p.groupSettings}}))},N.createElement(oe,{height:30})),N.createElement(kt,null))},_t=D.div`
  :hover {
    cursor: pointer;
  }
  ...
  ${({opened:e})=>e&&z`
    ...
    `};
`,kt=()=>{var e;const t=null==(e=H((e=>e.sidebarVisible)))||e,n=K();return N.createElement(_t,{opened:!t,onClick:()=>n(Oe())},N.createElement(te,{height:40}))},Ct=()=>{const[e,t]=S.exports.useState(""),[n,o]=S.exports.useState(0);return!1===H((e=>e.sidebarVisible))?null:N.createElement(mt,null,N.createElement(Et,{setSearchWord:t}),N.createElement(bt,{selectedGroup:n,setSelectedGroup:o}),N.createElement(ge,{searchWord:e}))};const It=D.section`
  display: flex;
...
`,Bt=()=>{const e=K(),t=H((e=>e.flowInfo)),{flow_name:n,flow_description:o,flow_active:r}=t||{};return N.createElement(It,null,N.createElement(St,null,N.createElement(Lt,null,N.createElement(ee,{height:14})),N.createElement(Mt,null,N.createElement(jt,null,n||"Loading ..."),N.createElement(Tt,null,o||"Loading ..."))),N.createElement(Dt,null,N.createElement(Pt,{onClick:()=>e(Le({windowConfig:{mainId:c.mainFlow}}))},"Diagram view"),N.createElement(Pt,{onClick:()=>e(Le({windowConfig:{mainId:c.codeEditor}}))},"Code editor"),N.createElement(Pt,null,N.createElement(Wt,null,N.createElement("span",null,"Active"),N.createElement($,{checked:!!r,icons:{checked:null,unchecked:null},onChange:t=>e(Le({flowInfo:{flow_active:+t.target.checked}}))}))),N.createElement(Pt,{onClick:()=>e(Le({windowConfig:{sideId:p.flowSettings}}))},N.createElement("img",{src:"/Drawflow-react/assets/flowsettings.758f2330.png",alt:""}))),N.createElement(Ot,null,N.createElement(zt,null,"Delete flow"),N.createElement($t,{onClick:()=>e(Ee())},"Save flow")))},Xt=D.button`
  position: absolute;
  top: 0;
  right: 0;
  background: none;
...
`,Nn=D.div``,Dn=D.div`
  ...
  ${({shift:e})=>e&&z`
    ...
    `}
`,Pn=()=>{var e;const t=H((e=>e)),n=S.exports.useRef(null),o=S.exports.useRef();return S.exports.useEffect((()=>{const{current:e}=n;if(e){const n={mode:"tree",modes:["code","form","text","tree","view","preview"],onChange(){const{current:e}=o;e?console.log(e.get()):console.trace("Something went wrong!")}};o.current&&o.current.destroy(),o.current=new W(e,n),o.current.set(t)}})),N.createElement(Dn,{shift:!(null==(e=t.sidebarVisible)||e),ref:n})},On=()=>{var e;const t=K(),n=null==(e=H((e=>e.sidebarVisible)))||e,o=H((e=>e.windowConfig.mainId)),r=H((e=>e.windowConfig.id));return o===c.templateNodeSettings?N.createElement(kn,{id:r}):o===c.mainFlow?N.createElement(In,null,N.createElement(Cn,null,!n&&N.createElement(kt,null),N.createElement("button",null,"Fetch flow version"),N.createElement("button",{onClick:()=>t(Ie(0))},"Version 1"),N.createElement("button",{onClick:()=>t(Ie(1))},"Version 2"),N.createElement("button",{onClick:()=>t(Ie(2))},"Version 3")),N.createElement(gt,null)):o===c.codeEditor?N.createElement(N.Fragment,null,N.createElement("span",{style:{position:"absolute",zIndex:2,backgroundColor:"white",top:-8}},!n&&N.createElement(kt,null)),N.createElement(Pn,null)):null},Ln=()=>{const e=H((e=>e.windowConfig.sideId));return e===p.flowSettings?N.createElement(Ut,null):e===p.groupSettings?N.createElement(rn,null):null},Mn=()=>{const e=K();return S.exports.useEffect((()=>{e(ye()),e(_e()),e(Ce())}),[]),N.createElement(Nn,null,N.createElement(Bt,null),N.createElement(Sn,null,N.createElement(Ct,null),N.createElement(On,null),N.createElement(Ln,null)))};B.render(N.createElement(S.exports.StrictMode,null,N.createElement(X,{store:je},N.createElement(Mn,null))),document.getElementById("root"));
