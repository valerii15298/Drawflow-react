...
`,De=I.button`
  ...
  color: #fff;
  border-radius: 4px;
`,Pe=()=>{const e=Se((e=>Q(e).editLock)),t=Ce();return N.createElement(Ne,null,!e&&N.createElement(De,null,"Clear"),N.createElement(De,{onClick:()=>t(K.setEditLock(!e))},e?"UnLock":"Lock"))},Oe=I.div`
  position: absolute;
  bottom: 10px;
  right: 10px;
  padding: 5px 10px;
...
`,Me=I.button`
  ...
  border-radius: 4px;
  padding: 3px 10px;
`,je=()=>{const e=Ce();return N.createElement(Oe,null,N.createElement(Me,{onClick:()=>e(K.zoom(!0))},"+"),N.createElement(Me,{onClick:()=>e(K.zoom(!1))},"-"),N.createElement(Me,{onClick:()=>e(K.zoom(null))},"reset"))},Le=D(P,w.isEqual),Te=I.svg`
  position: absolute;
  overflow: visible;
`,$e=I.path`
  :hover {
...
`,Pt=I.button`
  ...
  padding: 0;
`,Ot=({setSearchWord:e})=>{const t=Ce();return N.createElement(Nt,null,N.createElement(Dt,null,N.createElement(Be,null)),N.createElement(It,{type:"text",placeholder:"Search templates",onChange:t=>{e(t.target.value)}}),N.createElement(Pt,{onClick:()=>t(Ee({windowConfig:{sideId:X.groupSettings}}))},N.createElement(Xe,{height:30})),N.createElement(jt,null))},Mt=I.div`
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  ${({opened:e})=>e&&O`
    ...
    `};
`,jt=e=>{var t;const n=null==(t=Se((e=>e.sidebarVisible)))||t,o=Ce();return N.createElement(Mt,{opened:!n,onClick:()=>o(ye())},N.createElement(Fe,h({height:40},e)))},Lt=()=>{const[e,t]=S.exports.useState(""),[n,o]=S.exports.useState(0);return!1===Se((e=>e.sidebarVisible))?null:N.createElement(_t,null,N.createElement(Ot,{setSearchWord:t}),N.createElement(St,{selectedGroup:n,setSelectedGroup:o}),N.createElement(Et,{selectedGroup:n,searchWord:e}))};const Tt=I.section`
  display: flex;
...
`,Rt=()=>{const e=Ce(),t=Se((e=>e.flowInfo)),{flow_name:n,flow_description:o,flow_active:r}=t||{};return N.createElement(Tt,null,N.createElement($t,null,N.createElement(Ft,null,N.createElement(We,{height:14})),N.createElement(At,null,N.createElement(Xt,null,n||"Loading ..."),N.createElement(Jt,null,o||"Loading ..."))),N.createElement(Vt,null,N.createElement(Bt,{onClick:()=>e(Ee({windowConfig:{mainId:F.mainFlow}}))},"Diagram view"),N.createElement(Bt,{onClick:()=>e(Ee({windowConfig:{mainId:F.codeEditor}}))},"Code editor"),N.createElement(Bt,null,N.createElement(Gt,null,N.createElement("span",null,"Active"),N.createElement(M,{checked:!!r,icons:{checked:null,unchecked:null},onChange:t=>e(Ee({flowInfo:{flow_active:+t.target.checked}}))}))),N.createElement(Bt,{onClick:()=>e(Ee({windowConfig:{sideId:X.flowSettings}}))},N.createElement("img",{src:"/Drawflow-react/assets/flowsettings.758f2330.png",alt:""}))),N.createElement(Wt,null,N.createElement(Yt,null,"Delete flow"),N.createElement(qt,{onClick:()=>e(ie())},"Save flow")))},Ut=I.button`
  position: absolute;
  top: 0;
  right: 0;
  background: none;
...
`,Ln=I(tn)``,Tn=I(tn)``,$n=I(tn)``,zn=I.div`
  text-align: center;
`,Vn=({children:e})=>N.createElement(Nn,null,N.createElement(Dn,null,N.createElement(We,null)),N.createElement("span",null,e)),Bn=({setFormValues:e,control:t,remount:n,defaultValue:o})=>{const r=L({control:t,defaultValue:o}),[i,l]=S.exports.useState(!1);return N.createElement("div",{onMouseLeave:()=>i&&n()},N.createElement(fn,{values:r,setValues:t=>{l(!0),e(t)}}))},Wn=({path:e})=>{const t=e[e.length-1],n=`${e.join(".")}`,o=fe(t.replace(/_/g," "));return N.createElement(Pn,null,o,":",N.createElement(z,{name:n,render:({field:e})=>{const{value:n}=e,o=null===n;(e=>{const n=!(t in wn)||null===e||typeof wn[t]==typeof e;n||console.log({key:t,value:e,properValue:wn[t]})})(n);const r=t in wn?wn[t]:n;let i="string"==typeof r||o?"text":typeof r;return N.createElement("input",f(h({type:i},e),{value:null!=n?n:"",onChange:t=>{const{value:n}=t.target;e.onChange("number"===i?parseInt(n):n)}}))}}))},Fn=({path:e,obj:t})=>{var n;if("object"!=typeof t||null===t)return N.createElement(Wn,{path:e});const o=W(t).map((n=>{const o=t[n];return N.createElement(Fn,{key:[...e,n].join("."),path:[...e,n],obj:o})})),r=e[e.length-1],i=null!=(n=he[r])?n:fe(r.replace(/_/g," "));return N.createElement(Sn,null,N.createElement(Vn,null,i),N.createElement(On,null,o))},An=I(Sn)`
  position: relative;
...
`,Yn=I.div``,qn=({id:e})=>{const t=Se(Q),n=new q(t).getNode(e),{subnodes:o,out1:r}=n;n.parent;const i=N.createElement(An,null,N.createElement(Vn,null,"Subnodes"),N.createElement(Xn,null,o.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Jn,{key:t},n," #",t,":",e))))),l=N.createElement(An,null,N.createElement(Vn,null,"Next nodes"),N.createElement(Xn,null,r.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Jn,{key:t},n," #",t,":",e)))));return N.createElement(Yn,null,i,l)},Gn=e=>{var t;const{type:n}=S.exports.useContext(bn),o=Ce(),{defaultValues:r,setControl:i}=e,l=T({defaultValues:r}),{handleSubmit:s,formState:{errors:a},reset:d,control:c,getValues:u}=l;S.exports.useEffect((()=>{i(c)}),[]);const p=r,{name:m,description:g,icon_link:w}=p,b=null==(t=Se((e=>e.sidebarVisible)))||t;return N.createElement($,h({},l),N.createElement(xn,{onSubmit:s((e=>{"template"===n&&o(de(e)),"node"===n&&o(K.updateNode(e))}))},N.createElement(kn,{shift:!b},!b&&N.createElement(jn,null,N.createElement(jt,null)),N.createElement(Cn,{src:w}),N.createElement(_n,null,N.createElement(yn,null,m),N.createElement(En,null,g)),"node"===n&&N.createElement(qn,{id:r.this_node_unique_id})),N.createElement(In,{open:!0},N.createElement(Vn,null,"Default settings"),N.createElement(On,null,Object.entries(p).map((([e,t])=>"object"==typeof t&&null!==t||e in he?null:N.createElement(Wn,{key:e,path:[e]}))))),W(he).map((e=>p[e]?N.createElement(Fn,{key:e,obj:p[e],path:[e]}):null)),Object.keys(a).length&&N.createElement("div",null,N.createElement("pre",null,"Errors")),N.createElement(zn,null,N.createElement(Ln,{type:"submit"},"Save"),N.createElement($n,{type:"reset",onClick:()=>d()},"Reset"),N.createElement(Tn,{type:"button",onClick:()=>{"template"===n&&o(de(f(h({},u()),{delete:1})))}},"Delete"))))},Rn=({json:e})=>{const[t,n]=S.exports.useState(0),[o,r]=S.exports.useState(0),[i,l]=S.exports.useState(e),[s,a]=S.exports.useState();return N.createElement(Mn,null,N.createElement(vn,null,N.createElement(Gn,{key:`leftBar-${t}`,defaultValues:i,setControl:a}),s&&N.createElement(Bn,{key:`rightBar-${o}`,remount:()=>{r((e=>e+1))},setFormValues:e=>{l(e),n((e=>e+1))},control:s,defaultValue:i})))},Un=({id:e})=>{const t=Se((t=>Q(t).drawflow[e].data));return N.createElement(bn.Provider,{value:{type:"node"}},N.createElement(Rn,{json:t}))},Kn=({id:e})=>{const t=Se((t=>t.templates.find((({nodes_id:t})=>t===e))));return void 0===t?N.createElement("div",null,"Loading..."):N.createElement(bn.Provider,{value:{type:"template"}},N.createElement(Rn,{json:t}))},Hn=I.div`
  display: flex;
  align-items: normal;
  overflow-x: auto;
...
`,eo=I.div``,to=()=>{const e=Se((e=>e));return N.createElement(fn,{values:e,setValues:()=>null})},no=I.button`
  ...
  ${({selected:e})=>e&&O`
      font-weight: bold;
    `}
`,oo=()=>{var e;const t=null==(e=Se((e=>e.sidebarVisible)))||e,n=Se((e=>e.flows)),o=Se((e=>e.flows.length)),r=Se((e=>e.version)),i=Ce(),l=[t?null:N.createElement(jt,{style:{height:"2em"},key:-1}),N.createElement(no,{key:0,selected:0===r,onClick:()=>i(me(0))},"Prototyping",n[0]&&":"+Object.keys(n[0].drawflow).length)];for(let s=o-1;s>0;--s)l.push(N.createElement(no,{key:s,selected:s===r,onClick:()=>i(me(s))},"Version ",s,n[s]&&":"+Object.keys(n[s].drawflow).length));return N.createElement(Hn,null,l)},ro=()=>N.createElement(Qn,null,N.createElement(oo,null),N.createElement(vt,null)),io=()=>{var e;Ce();const t=null==(e=Se((e=>e.sidebarVisible)))||e,n=Se((e=>e.windowConfig.mainId)),o=Se((e=>e.windowConfig.id)),r=Se((e=>e.version));return n===F.templateNodeSettings?N.createElement(N.Fragment,null,N.createElement(Kn,{key:o,id:o})):n===F.nodeSettings?N.createElement(N.Fragment,null,N.createElement(Un,{key:o,id:o})):n===F.mainFlow?N.createElement(ro,{key:r}):n===F.codeEditor?N.createElement(N.Fragment,null,N.createElement("span",{style:{position:"absolute",zIndex:2,backgroundColor:"white",top:-8}},!t&&N.createElement(jt,null)),N.createElement(to,null)):null},lo=()=>{const e=Se((e=>e.windowConfig.sideId));return e===X.flowSettings?N.createElement(en,null):e===X.groupSettings?N.createElement(gn,null):null},so=()=>{const e=Ce();return S.exports.useEffect((()=>{e(re()),e(le()),e(ae()),e(pe())}),[]),N.createElement(eo,null,N.createElement(Rt,null),N.createElement(Zn,null,N.createElement(Lt,null),N.createElement(io,null),N.createElement(lo,null)))};V.render(N.createElement(S.exports.StrictMode,null,N.createElement(B,{store:ke},N.createElement(so,null))),document.getElementById("root"));
