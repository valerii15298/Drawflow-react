...
`,Ot=({setSearchWord:e})=>{const t=Se();return N.createElement(Nt,null,N.createElement(Dt,null,N.createElement(Fe,null)),N.createElement(It,{type:"text",placeholder:"Search templates",onChange:t=>{e(t.target.value)}}),N.createElement(Pt,{onClick:()=>t(Ee({windowConfig:{sideId:J.groupSettings}}))},N.createElement(Je,{height:30})),N.createElement(jt,null))},Mt=I.div`
  ...
  ${({opened:e})=>e&&O`
    ...
    `};
`,jt=e=>{var t;const n=null==(t=Ce((e=>e.sidebarVisible)))||t,o=Se();return N.createElement(Mt,{opened:!n,onClick:()=>o(ye())},N.createElement(We,h({height:40},e)))},Lt=()=>{const[e,t]=C.exports.useState(""),[n,o]=C.exports.useState(0);return!1===Ce((e=>e.sidebarVisible))?null:N.createElement(_t,null,N.createElement(Ot,{setSearchWord:t}),N.createElement(Ct,{selectedGroup:n,setSelectedGroup:o}),N.createElement(Et,{selectedGroup:n,searchWord:e}))};const Tt=I.section`
  display: flex;
...
`,Rt=()=>{const e=Se(),t=Ce((e=>e.flowInfo)),{flow_name:n,flow_description:o,flow_active:r}=t||{};return N.createElement(Tt,null,N.createElement(zt,null,N.createElement(Wt,null,N.createElement(Be,{height:14})),N.createElement(At,null,N.createElement(Jt,null,n||"Loading ..."),N.createElement(Xt,null,o||"Loading ..."))),N.createElement(Vt,null,N.createElement(Ft,{onClick:()=>e(Ee({windowConfig:{mainId:W.mainFlow}}))},"Diagram view"),N.createElement(Ft,{onClick:()=>e(Ee({windowConfig:{mainId:W.codeEditor}}))},"Code editor"),N.createElement(Ft,null,N.createElement(Gt,null,N.createElement("span",null,"Active"),N.createElement(M,{checked:!!r,icons:{checked:null,unchecked:null},onChange:t=>e(Ee({flowInfo:{flow_active:+t.target.checked}}))}))),N.createElement(Ft,{onClick:()=>e(Ee({windowConfig:{sideId:J.flowSettings}}))},N.createElement("img",{src:"/Drawflow-react/assets/flowsettings.758f2330.png",alt:""}))),N.createElement(Bt,null,N.createElement(Yt,null,"Delete flow"),N.createElement(qt,{onClick:()=>e(ie())},"Save flow")))},Ut=I.button`
  position: absolute;
  top: 0;
  right: 0;
  background: none;
...
`,Ln=I(tn)``,Tn=I(tn)``,zn=I(tn)``,$n=I.div`
  text-align: center;
`,Vn=({children:e})=>N.createElement(Nn,null,N.createElement(Dn,null,N.createElement(Be,null)),N.createElement("span",null,e)),Fn=({setFormValues:e,control:t,remount:n,defaultValue:o})=>{const r=L({control:t,defaultValue:o}),[i,l]=C.exports.useState(!1);return N.createElement("div",{onMouseLeave:()=>i&&n()},N.createElement(fn,{values:r,setValues:t=>{l(!0),e(t)}}))},Bn=({path:e})=>{const t=e[e.length-1],n=`${e.join(".")}`,o=fe(t.replace(/_/g," "));return N.createElement(Pn,null,o,":",N.createElement($,{name:n,render:({field:e})=>{const{value:n}=e,o=null===n;(e=>{const n=!(t in wn)||null===e||typeof wn[t]==typeof e;n||console.log({key:t,value:e,properValue:wn[t]})})(n);const r=t in wn?wn[t]:n;let i="string"==typeof r||o?"text":typeof r;return N.createElement("input",f(h({type:i},e),{value:null!=n?n:"",onChange:t=>{const{value:n}=t.target;e.onChange("number"===i?parseInt(n):n)}}))}}))},Wn=({path:e,obj:t})=>{var n;if("object"!=typeof t||null===t)return N.createElement(Bn,{path:e});const o=B(t).map((n=>{const o=t[n];return N.createElement(Wn,{key:[...e,n].join("."),path:[...e,n],obj:o})})),r=e[e.length-1],i=null!=(n=he[r])?n:fe(r.replace(/_/g," "));return N.createElement(Cn,null,N.createElement(Vn,null,i),N.createElement(On,null,o))},An=I(Cn)`
  position: relative;
...
`,qn=e=>{ke.dispatch(Ee({windowConfig:{id:e,mainId:W.nodeSettings}}))},Gn=I.button`
  background-color: white;
  border: 0;
  border-radius: 0.4em;
  padding: 0.3em;
  margin: 0.5em;
`,Rn=({node:e,getNextListFromNode:t})=>{const{id:n,nodeState:{positionNumber:o,data:{name:r}}}=e;return N.createElement(An,{leftShift:"1em"},N.createElement(Vn,null,r," #",n,":",o,N.createElement(Gn,{onClick:()=>qn(n),key:n},"Jump")),N.createElement(On,null,t(e).map((e=>N.createElement(Rn,{getNextListFromNode:t,key:e.id,node:e})))))},Un=({id:e})=>{const t=Ce(Q),n=new q(t).getNode(e),{subnodes:o,out1:r,prevDirectNodes:i}=n,l=C.exports.useRef(null),s=e=>{if(!0!==e.target.open)return;const t=e.target.parentNode;t===l.current&&Array.from(t.children).forEach((t=>{t!==e.target&&(t.open=!1)}))},a=N.createElement(An,{onToggle:s,leftShift:"0",open:!1},N.createElement(Vn,null,"Subnodes"),o.length>0&&N.createElement(Jn,{style:{zIndex:3}},o.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Xn,{onClick:()=>qn(t),key:t},n," #",t,":",e))))),d=N.createElement(An,{leftShift:"0",onToggle:s},N.createElement(Vn,null,"Next nodes"),r.length>0&&N.createElement(Jn,{style:{zIndex:1}},r.map((e=>N.createElement(Rn,{getNextListFromNode:({out1:e})=>e,key:e.id,node:e}))))),c=N.createElement(An,{leftShift:"0",onToggle:s},N.createElement(Vn,null,"Prev nodes"),i.length>0&&N.createElement(Jn,{style:{zIndex:2}},i.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Xn,{key:t},n," #",t,":",e)))));return N.createElement(Yn,{ref:l},a,c,d)},Kn=e=>{var t;const{type:n}=C.exports.useContext(bn),o=Se(),{defaultValues:r,setControl:i}=e,l=T({defaultValues:r}),{handleSubmit:s,formState:{errors:a},reset:d,control:c,getValues:u}=l;C.exports.useEffect((()=>{i(c)}),[]);const p=r,{name:m,description:g,icon_link:w}=p,b=null==(t=Ce((e=>e.sidebarVisible)))||t;return N.createElement(z,h({},l),N.createElement(xn,{onSubmit:s((e=>{"template"===n&&o(de(e)),"node"===n&&o(K.updateNode(e))}))},N.createElement(kn,{shift:!b},!b&&N.createElement(jn,null,N.createElement(jt,null)),N.createElement(Sn,{src:w}),N.createElement(_n,null,N.createElement(yn,null,m),N.createElement(En,null,g)),"node"===n&&N.createElement(Un,{id:r.this_node_unique_id})),N.createElement(In,{open:!0},N.createElement(Vn,null,"Default settings"),N.createElement(On,null,Object.entries(p).map((([e,t])=>"object"==typeof t&&null!==t||e in he?null:N.createElement(Bn,{key:e,path:[e]}))))),B(he).map((e=>p[e]?N.createElement(Wn,{key:e,obj:p[e],path:[e]}):null)),Object.keys(a).length&&N.createElement("div",null,N.createElement("pre",null,"Errors")),N.createElement($n,null,N.createElement(Ln,{type:"submit"},"Save"),N.createElement(zn,{type:"reset",onClick:()=>d()},"Reset"),N.createElement(Tn,{type:"button",onClick:()=>{"template"===n&&o(de(f(h({},u()),{delete:1})))}},"Delete"))))},Hn=({json:e})=>{const[t,n]=C.exports.useState(0),[o,r]=C.exports.useState(0),[i,l]=C.exports.useState(e),[s,a]=C.exports.useState();return N.createElement(Mn,null,N.createElement(vn,null,N.createElement(Kn,{key:`leftBar-${t}`,defaultValues:i,setControl:a}),s&&N.createElement(Fn,{key:`rightBar-${o}`,remount:()=>{r((e=>e+1))},setFormValues:e=>{l(e),n((e=>e+1))},control:s,defaultValue:i})))},Qn=({id:e})=>{const t=Ce((t=>Q(t).drawflow[e].data));return N.createElement(bn.Provider,{value:{type:"node"}},N.createElement(Hn,{json:t}))},Zn=({id:e})=>{const t=Ce((t=>t.templates.find((({nodes_id:t})=>t===e))));return void 0===t?N.createElement("div",null,"Loading..."):N.createElement(bn.Provider,{value:{type:"template"}},N.createElement(Hn,{json:t}))},eo=I.div`
  display: flex;
  align-items: normal;
  overflow-x: auto;
