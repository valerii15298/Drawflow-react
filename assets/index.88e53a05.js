...
`,Et=I.div`
  ...
  ${({selected:e})=>e&&P`
    ...
    `};
`,_t=({selectedGroup:e,setSelectedGroup:t})=>{Se();const n=Ie((e=>e.groups));return N.createElement(yt,null,N.createElement(Et,{key:0,selected:0===e,onClick:()=>t(0)},"All"),Object.values(n).map((({id:n,node_group_name:o,node_group_order:r})=>N.createElement(Et,{key:n,selected:n===e,onClick:()=>t(n)},o))))},kt=I.input`
  display: block;
  width: 75%;
  height: 40px;
...
`,Nt=({setSearchWord:e})=>{const t=Se();return N.createElement(Ct,null,N.createElement(St,null,N.createElement(Ve,null)),N.createElement(kt,{type:"text",placeholder:"Search templates",onChange:t=>{e(t.target.value)}}),N.createElement(It,{onClick:()=>t(_e({windowConfig:{sideId:X.groupSettings}}))},N.createElement(Ae,{height:30})),N.createElement(Dt,null))},jt=I.div`
  ...
  ${({opened:e})=>e&&P`
    ...
    `};
`,Dt=e=>{var t;const n=null==(t=Ie((e=>e.sidebarVisible)))||t,o=Se();return N.createElement(jt,{opened:!n,onClick:()=>o(Ee())},N.createElement(Fe,h({height:40},e)))},Pt=()=>{const[e,t]=S.exports.useState(""),[n,o]=S.exports.useState(0);return!1===Ie((e=>e.sidebarVisible))?null:N.createElement(xt,null,N.createElement(Nt,{setSearchWord:t}),N.createElement(_t,{selectedGroup:n,setSelectedGroup:o}),N.createElement(vt,{selectedGroup:n,searchWord:e}))};const Ot=I.section`
  display: flex;
