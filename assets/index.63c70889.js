...
`,De=I.button`
  ...
  color: #fff;
  border-radius: 4px;
`,Oe=()=>{const e=Se((e=>Q(e).editLock)),t=Ce();return N.createElement(Ne,null,!e&&N.createElement(De,null,"Clear"),N.createElement(De,{onClick:()=>t(K.setEditLock(!e))},e?"UnLock":"Lock"))},Pe=I.div`
  position: absolute;
  bottom: 10px;
  right: 10px;
  padding: 5px 10px;
...
`,Me=I.button`
  ...
  border-radius: 4px;
  padding: 3px 10px;
`,je=()=>{const e=Ce();return N.createElement(Pe,null,N.createElement(Me,{onClick:()=>e(K.zoom(!0))},"+"),N.createElement(Me,{onClick:()=>e(K.zoom(!1))},"-"),N.createElement(Me,{onClick:()=>e(K.zoom(null))},"reset"))},Le=D(O,w.isEqual),Te=I.svg`
  position: absolute;
  overflow: visible;
`,$e=I.path`
  :hover {
...
`,lt={[l.in]:[it],[l.out]:[ot,rt]},st=e=>{const{nodeId:t,portId:n,type:o}=e,r=Ce(),i=(l=e,Se(S.exports.useMemo((()=>Le((e=>{const{portToConnect:t}=Q(e);if(void 0===t)return!1;const n=JSON.parse(JSON.stringify(t));return delete n.pos,w.isEqual(l,n)}),(e=>e))),[l])));var l;const s=(a=t,Se(S.exports.useMemo((()=>Le((e=>Q(e).drawflow[a].isSub),(e=>e))),[a])));var a;const d=lt[o][n-1];return N.createElement(d,{isSub:s,onMouseDown:e=>{e.stopPropagation(),r(K.selectPort({type:o,nodeId:t,portId:n}))},onMouseUp:()=>{r(K.portMouseUp({nodeId:t,portId:n,PortType:o}))}},N.createElement(tt,{visible:i}))},at=e=>{const{id:t,port:n,type:o}=e,r=[];for(let i=1;i<=n[o];i++)r.push(N.createElement(st,{key:i,nodeId:t,portId:i,type:o}));return N.createElement("div",{className:`${o}puts`},r)},dt=I.div`
  ...
  ${({selected:e})=>e&&P`
      ...
      z-index: 2;
    `};
`,ct=({id:e})=>{const t=Se(S.exports.useMemo((()=>Le((e=>Q(e).config.drag),(e=>e))),[])),n=Se((e=>Q(e).nodeId)),o=(e=>Se(S.exports.useMemo((()=>Le((t=>Q(t).drawflow[e].pos),(e=>e))),[e])))(e),r=(e=>Se(S.exports.useMemo((()=>Le((t=>{const n=Q(t).select;return(null==n?void 0:n.selectId)===e&&"node"===n.type}),(e=>e))),[e])))(e),i=Ce(),s=S.exports.useRef(null),a=(e=>Se(S.exports.useMemo((()=>Le((t=>{const n=JSON.parse(JSON.stringify(Q(t).drawflow[e]));return delete n.pos,n}),(e=>e))),[e])))(e),{port:d}=a;return S.exports.useEffect((()=>{if(s.current){const{offsetHeight:t,offsetWidth:n}=s.current;i(K.nodeSize({height:t,width:n,id:e})),console.log("align node")}}),[]),S.exports.useEffect((()=>{const t=(t,n)=>Array.from(n.querySelector(`.${t}puts`).children).map(((n,r)=>{const i=parseInt(getComputedStyle(n).left)+o.x,l=parseInt(getComputedStyle(n).top)+o.y;return{nodeId:e,pos:{x:i,y:l},portId:r+1,type:t}}));if(s.current){const e=t(l.in,s.current),n=t(l.out,s.current);i(K.pushPorts([...e,...n]))}}),[i,e,o]),S.exports.useEffect((()=>{if(s.current&&n-1===e&&t){const{offsetHeight:t,offsetWidth:n}=s.current;i(K.moveNode({nodeId:e,dx:.2*-n,dy:.2*-t}))}}),[]),N.createElement(dt,{selected:r,ref:s,style:h({left:o.x,top:o.y},a.isSub?Ze:et),isSub:a.isSub,onMouseDown:t=>{t.stopPropagation();const{clientX:n,clientY:o}=t;i(K.select({type:"node",selectId:e})),i(K.setMouseBlockDragPos({clientX:n,clientY:o}))},onContextMenu:()=>{},onDoubleClick:()=>{}},N.createElement(Qe,h({},a)),!a.isSub&&N.createElement(N.Fragment,null,N.createElement("button",{onMouseDown:t=>{t.preventDefault(),i(K.toggleSubnodes({id:e})),t.stopPropagation()}},"toggle sub"),N.createElement("button",{onMouseDown:t=>{t.preventDefault(),i(K.toggleChildren({id:e})),t.stopPropagation()}},"toggle children")),N.createElement(at,{id:e,port:d,type:l.in}),N.createElement(at,{id:e,port:d,type:l.out}))},ut=()=>{const e=Se(S.exports.useMemo((()=>Le((e=>{const{drawflow:t}=Q(e);return Object.entries(t).filter((([e,{visible:t}])=>!1!==t)).map((([e])=>Number(e)))}),(e=>e))),[]));return N.createElement(N.Fragment,null,e.map((e=>N.createElement(ct,{key:e,id:e}))))},pt=({id:e})=>{const t=(n=e,Se(S.exports.useMemo((()=>Le((e=>{var t,o;const r=Q(e),{startId:i,startPort:s,endId:a,endPort:d}=r.connections[n],c=null==(t=r.ports.find((e=>e.nodeId===i&&e.portId===s&&e.type===l.out)))?void 0:t.pos,u=null==(o=r.ports.find((e=>e.nodeId===a&&e.portId===d&&e.type===l.in)))?void 0:o.pos;return c&&u?Z(c,u):""}),(e=>e))),[n])));var n;return N.createElement(ze,{key:e,id:e,d:t})},gt=()=>{const e=Se(S.exports.useMemo((()=>Le((e=>{const{connections:t}=Q(e);return t.reduce(((e,t,n)=>(t.visible&&e.push(n),e)),[])}),(e=>e))),[])).map((e=>N.createElement(pt,{key:e,id:e})));return N.createElement(N.Fragment,null,e)};const mt=I.div`
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`,bt=I.button`
  ...
  background-color: #217ce8;
  left: 10px;
`,vt=()=>{(()=>{const e=Ce(),[t]=Ie(r.backgroundOpacity,50),[n]=Ie(r.backgroundBlur,50),[o]=Ie(r.backgroundImageUrl,"");S.exports.useEffect((()=>{e(Ee({windowConfig:{background:{opacity:t,blur:n,imageUrl:o}}}))}),[])})();const e=Se(S.exports.useMemo((()=>Le((e=>{const t=Q(e),{config:{zoom:n},newPathDirection:o,canvasDrag:r}=t;return{config:{zoom:n},newPathDirection:o,canvasDrag:r}}),(e=>e))),[])),{config:{zoom:t},newPathDirection:n,canvasDrag:o}=e,i=Ce(),l=S.exports.useRef(null),s=S.exports.useRef(null);S.exports.useEffect((()=>{const{current:e}=l;e&&ft(e,0,0,t.value)}),[o,t.value]),S.exports.useEffect((()=>{const{current:e}=l;if(e){const t=e.getBoundingClientRect(),n={x:t.x,y:t.y,width:e.clientWidth,height:e.clientHeight};i(ve(n))}const{current:t}=s;if(t){const e=t.getBoundingClientRect(),n={x:e.x,y:e.y,width:t.clientWidth,height:t.clientHeight};i(Ee({precanvas:n}))}}));const{opacity:a,blur:d,imageUrl:c}=Se((e=>e.windowConfig.background));return N.createElement(mt,{ref:s,className:"drawflow",tabIndex:0,onKeyDownCapture:e=>{"Delete"===e.key&&(i(K.deletePath()),i(K.deleteNode())),e.ctrlKey&&"c"===e.key&&i(K.copyNode()),e.ctrlKey&&"v"===e.key&&i(xe())},onMouseDown:()=>{i(K.canvasDrag(!0)),i(K.unSelect())},onMouseUp:()=>i(K.canvasMouseUp()),onMouseMove:e=>{const{clientX:n,clientY:r,movementX:s,movementY:a}=e,{current:d}=l;o&&d&&ft(d,s,a,t.value),i(K.canvasMouseMove({clientX:n,clientY:r,movementX:s,movementY:a}))},onMouseEnter:e=>{const{clientX:t,clientY:n}=e;i(we({clientX:t,clientY:n}))},style:{backgroundColor:`rgba(251, 251, 251, ${a}%)`}},N.createElement(wt,{style:{backgroundImage:`url(${c})`,filter:`blur(${d/10}px)`}}),N.createElement(Oe,null),N.createElement(je,null),N.createElement(bt,{onClick:e=>{e.preventDefault(),i(ue())}},"Commit"),N.createElement(ht,{ref:l,style:{}},N.createElement(ut,null),N.createElement(gt,null),n&&N.createElement(Ve,null)))};const xt=I.div`
  padding: 0.5em;
  display: grid;
...
`,Ct=I.div`
  ...
  ${({selected:e})=>e&&P`
    ...
    `};
`,St=({selectedGroup:e,setSelectedGroup:t})=>{Ce();const n=Se((e=>e.groups));return N.createElement(kt,null,N.createElement(Ct,{key:0,selected:0===e,onClick:()=>t(0)},"All"),Object.values(n).map((({id:n,node_group_name:o,node_group_order:r})=>N.createElement(Ct,{key:n,selected:n===e,onClick:()=>t(n)},o))))},It=I.input`
  display: block;
  width: 75%;
  height: 40px;
...
`,Ot=I.button`
  ...
  padding: 0;
`,Pt=({setSearchWord:e})=>{const t=Ce();return N.createElement(Nt,null,N.createElement(Dt,null,N.createElement(Ae,null)),N.createElement(It,{type:"text",placeholder:"Search templates",onChange:t=>{e(t.target.value)}}),N.createElement(Ot,{onClick:()=>t(Ee({windowConfig:{sideId:J.groupSettings}}))},N.createElement(Je,{height:30})),N.createElement(jt,null))},Mt=I.div`
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  ${({opened:e})=>e&&P`
    ...
    `};
`,jt=e=>{var t;const n=null==(t=Se((e=>e.sidebarVisible)))||t,o=Ce();return N.createElement(Mt,{opened:!n,onClick:()=>o(ye())},N.createElement(We,h({height:40},e)))},Lt=()=>{const[e,t]=S.exports.useState(""),[n,o]=S.exports.useState(0);return!1===Se((e=>e.sidebarVisible))?null:N.createElement(_t,null,N.createElement(Pt,{setSearchWord:t}),N.createElement(St,{selectedGroup:n,setSelectedGroup:o}),N.createElement(Et,{selectedGroup:n,searchWord:e}))};const Tt=I.section`
  display: flex;
...
`,Rt=()=>{const e=Ce(),t=Se((e=>e.flowInfo)),{flow_name:n,flow_description:o,flow_active:r}=t||{};return N.createElement(Tt,null,N.createElement($t,null,N.createElement(Wt,null,N.createElement(Be,{height:14})),N.createElement(Ft,null,N.createElement(Jt,null,n||"Loading ..."),N.createElement(Xt,null,o||"Loading ..."))),N.createElement(Vt,null,N.createElement(At,{onClick:()=>e(Ee({windowConfig:{mainId:W.mainFlow}}))},"Diagram view"),N.createElement(At,{onClick:()=>e(Ee({windowConfig:{mainId:W.codeEditor}}))},"Code editor"),N.createElement(At,null,N.createElement(Gt,null,N.createElement("span",null,"Active"),N.createElement(M,{checked:!!r,icons:{checked:null,unchecked:null},onChange:t=>e(Ee({flowInfo:{flow_active:+t.target.checked}}))}))),N.createElement(At,{onClick:()=>e(Ee({windowConfig:{sideId:J.flowSettings}}))},N.createElement("img",{src:"/Drawflow-react/assets/flowsettings.758f2330.png",alt:""}))),N.createElement(Bt,null,N.createElement(Yt,null,"Delete flow"),N.createElement(qt,{onClick:()=>e(ie())},"Save flow")))},Ut=I.button`
  position: absolute;
  top: 0;
  right: 0;
  background: none;
...
`,en=()=>{const e=Se((e=>e.flowInfo)),t=Ce(),[n,o]=S.exports.useState([]);S.exports.useEffect((()=>{(async()=>{const e=await oe(te.fetchBackgroundImages,{lab_test:1}),{flow_canvas_background_image:t}=e,n=t.map((({image_link:e})=>e));o(n)})().then()}),[]);const{flow_name:i,flow_description:l,run_times_max:s,user_run_limit_seconds:a}=e||{},[d,c]=Ie(r.backgroundOpacity,50),[u,p]=Ie(r.backgroundBlur,50),[g,m]=Ie(r.backgroundImageUrl,""),w=(e,n)=>{const o=Object.keys(e)[0],r=e[o];return N.createElement("input",f(h({},n),{value:null!=r?r:"Loading ...",onChange:e=>{t(Ee({flowInfo:{[o]:e.target.value}}))}}))};return N.createElement(Kt,null,N.createElement(Ut,{onClick:()=>t(Ee({windowConfig:{sideId:J.none}}))},N.createElement(Fe,{width:19,height:19})),N.createElement(Ht,null,"Flow name:",w({flow_name:i},{type:"text"})),N.createElement(Ht,null,"Flow description:",w({flow_description:l},{type:"text"})),N.createElement(Ht,null,"Max run times:",w({run_times_max:s},{type:"number"})),N.createElement(Ht,null,"User run limit seconds:",w({user_run_limit_seconds:a},{type:"number"})),N.createElement(Zt,null,N.createElement("label",null,"Opacity:",N.createElement("input",{type:"range",value:null!=d?d:0,min:0,max:100,onChange:e=>{const n=+e.target.value;c(n),t(Ee({windowConfig:{background:{opacity:n}}}))}})),N.createElement("label",null,"Blur:",N.createElement("input",{onChange:e=>{const n=+e.target.value;p(n),t(Ee({windowConfig:{background:{blur:n}}}))},type:"range",min:0,max:100,value:u})),N.createElement(Qt,null,n.map((e=>N.createElement("button",{key:e,onClick:()=>{m(e),t(Ee({windowConfig:{background:{imageUrl:e}}}))}},N.createElement("img",{style:{border:g===e?"2px solid blue":""},src:e,alt:"Background image"})))))))},tn=I.button`
  /* margin-left: auto */
  padding: 4px 6px;
  text-align: center;
  outline: none;
...
`,mn=()=>{var e;const t=Se((e=>e.groups)),n=Ce(),[o,r]=S.exports.useState(t),i=(e,t)=>{const n=h(h({},o[e]),t);r(f(h({},o),{[e]:n}))};if(Object.keys(t).length!==Object.keys(o).length){const n={};for(const[r,i]of Object.entries(t))n[Number(r)]=w.merge(i,null!=(e=o[Number(r)])?e:{});r(n)}return N.createElement(on,null,N.createElement(un,null,"Node groups"),Object.values(o).map((({id:e,node_group_name:t,node_group_order:r,node_group_description:l})=>N.createElement(rn,{key:e},N.createElement(cn,null,N.createElement(ln,null,e),N.createElement(an,{onClick:()=>{window.confirm(`Do you really wanna delete group ${t}, ID.${e}`)&&n(se({id:e,delete:1}))}},"Delete"),N.createElement(dn,{onClick:()=>{window.confirm(`Do you really wanna save group ${t}, ID.${e}`)&&n(se(o[e]))}},"Save")),N.createElement(pn,{value:t,type:"text",onChange:t=>{i(e,{node_group_name:t.target.value})}}),N.createElement(gn,{value:l,onChange:t=>{i(e,{node_group_description:t.target.value})}})))),N.createElement(nn,null,N.createElement(sn,{onClick:()=>{n(se({id:0,node_group_order:0,node_group_name:"Group name",node_group_description:"Group description"}))}},"Add new")))};const hn=I.div`
  ...
  ${({shift:e})=>e&&P`
    ...
    `}
`,fn=({values:e,setValues:t})=>{const n=Se((e=>e.sidebarVisible)),o=S.exports.useRef(null),r=S.exports.useRef();return S.exports.useEffect((()=>{if(o.current&&!r.current){const e={mode:"tree",modes:["code","form","text","tree","view","preview"],onChangeText(e){try{const n=JSON.parse(e);t(n)}catch(n){console.log({e:n})}}};r.current=new j(o.current,e)}return()=>{var e;null==(e=r.current)||e.destroy()}}),[]),S.exports.useEffect((()=>{r.current&&JSON.stringify(r.current.get())!==JSON.stringify(e)&&r.current.update(e)}),[e]),N.createElement(hn,{shift:!(null==n||n),ref:o})},wn={flow_node_type_id:0,nodes_id:0,node_scrdata_id:0,flow_action_scrdata_id:0,order:0,nodes_group_id:0,name:"**",description:"**",icon_link:"https://tastypoints.io/akm/tasty_images/pQ6hREGM.png",icon_link_selected:"https://tastypoints.io/akm/tasty_images/pQ6hREGM.png",nodes_tooltip:"",id_priority:0,active:0,execution_wait_time_seconds:0,execute_node_specific_date_time:"2020-11-11T19:30",loop_cycles:0,node_settings_json:{},node_response_settings_json:{},loop_cycle_reached_jump_to_node:0,node_attributes:[],node_object_lists:{},node_story:"Node story"},bn=S.exports.createContext({type:"template"}),vn=I.div`
  display: grid;
...
`,On=I.label`
  ...
  flex-wrap: nowrap;
  border-bottom: 2px solid blue;
`,Pn=I.div``;I.button``;const Mn=I.div`
  flex: 1;
  height: max-content;
`,jn=I.div`
  margin-left: -0.2em;
`,Ln=I(tn)``,Tn=I(tn)``,$n=I(tn)``,zn=I.div`
  text-align: center;
`,Vn=({children:e})=>N.createElement(Nn,null,N.createElement(Dn,null,N.createElement(Be,null)),N.createElement("span",null,e)),An=({setFormValues:e,control:t,remount:n,defaultValue:o})=>{const r=L({control:t,defaultValue:o}),[i,l]=S.exports.useState(!1);return N.createElement("div",{onMouseLeave:()=>i&&n()},N.createElement(fn,{values:r,setValues:t=>{l(!0),e(t)}}))},Bn=({path:e})=>{const t=e[e.length-1],n=`${e.join(".")}`,o=fe(t.replace(/_/g," "));return N.createElement(On,null,o,":",N.createElement(z,{name:n,render:({field:e})=>{const{value:n}=e,o=null===n;(e=>{const n=!(t in wn)||null===e||typeof wn[t]==typeof e;n||console.log({key:t,value:e,properValue:wn[t]})})(n);const r=t in wn?wn[t]:n;let i="string"==typeof r||o?"text":typeof r;return N.createElement("input",f(h({type:i},e),{value:null!=n?n:"",onChange:t=>{const{value:n}=t.target;e.onChange("number"===i?parseInt(n):n)}}))}}))},Wn=({path:e,obj:t})=>{var n;if("object"!=typeof t||null===t)return N.createElement(Bn,{path:e});const o=B(t).map((n=>{const o=t[n];return N.createElement(Wn,{key:[...e,n].join("."),path:[...e,n],obj:o})})),r=e[e.length-1],i=null!=(n=he[r])?n:fe(r.replace(/_/g," "));return N.createElement(Sn,null,N.createElement(Vn,null,i),N.createElement(Pn,null,o))},Fn=I(Sn)`
  position: relative;
...
`,Yn=I.div``,qn=({id:e})=>{const t=Se(Q),n=new q(t).getNode(e),{subnodes:o,out1:r}=n;n.parent;const i=N.createElement(Fn,null,N.createElement(Vn,null,"Subnodes"),N.createElement(Jn,null,o.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Xn,{key:t},n," #",t,":",e))))),l=N.createElement(Fn,null,N.createElement(Vn,null,"Next nodes"),N.createElement(Jn,null,r.map((({nodeState:{positionNumber:e,id:t,data:{name:n}}})=>N.createElement(Xn,{key:t},n," #",t,":",e)))));return N.createElement(Yn,null,i,l)},Gn=e=>{var t;const{type:n}=S.exports.useContext(bn),o=Ce(),{defaultValues:r,setControl:i}=e,l=T({defaultValues:r}),{handleSubmit:s,formState:{errors:a},reset:d,control:c,getValues:u}=l;S.exports.useEffect((()=>{i(c)}),[]);const p=r,{name:g,description:m,icon_link:w}=p,b=null==(t=Se((e=>e.sidebarVisible)))||t;return N.createElement($,h({},l),N.createElement(xn,{onSubmit:s((e=>{"template"===n&&o(de(e)),"node"===n&&o(K.updateNode(e))}))},N.createElement(kn,{shift:!b},!b&&N.createElement(jn,null,N.createElement(jt,null)),N.createElement(Cn,{src:w}),N.createElement(_n,null,N.createElement(yn,null,g),N.createElement(En,null,m)),"node"===n&&N.createElement(qn,{id:r.this_node_unique_id})),N.createElement(In,{open:!0},N.createElement(Vn,null,"Default settings"),N.createElement(Pn,null,Object.entries(p).map((([e,t])=>"object"==typeof t&&null!==t||e in he?null:N.createElement(Bn,{key:e,path:[e]}))))),B(he).map((e=>p[e]?N.createElement(Wn,{key:e,obj:p[e],path:[e]}):null)),Object.keys(a).length&&N.createElement("div",null,N.createElement("pre",null,"Errors")),N.createElement(zn,null,N.createElement(Ln,{type:"submit"},"Save"),N.createElement($n,{type:"reset",onClick:()=>d()},"Reset"),N.createElement(Tn,{type:"button",onClick:()=>{"template"===n&&o(de(f(h({},u()),{delete:1})))}},"Delete"))))},Rn=({json:e})=>{const[t,n]=S.exports.useState(0),[o,r]=S.exports.useState(0),[i,l]=S.exports.useState(e),[s,a]=S.exports.useState();return N.createElement(Mn,null,N.createElement(vn,null,N.createElement(Gn,{key:`leftBar-${t}`,defaultValues:i,setControl:a}),s&&N.createElement(An,{key:`rightBar-${o}`,remount:()=>{r((e=>e+1))},setFormValues:e=>{l(e),n((e=>e+1))},control:s,defaultValue:i})))},Un=({id:e})=>{const t=Se((t=>Q(t).drawflow[e].data));return N.createElement(bn.Provider,{value:{type:"node"}},N.createElement(Rn,{json:t}))},Kn=({id:e})=>{const t=Se((t=>t.templates.find((({nodes_id:t})=>t===e))));return void 0===t?N.createElement("div",null,"Loading..."):N.createElement(bn.Provider,{value:{type:"template"}},N.createElement(Rn,{json:t}))},Hn=I.div`
  display: flex;
  align-items: normal;
  overflow-x: auto;
...
`,Zn=I.main`
  display: flex;
  position: relative;
`,eo=I.div``,to=()=>{const e=Se((e=>e));return N.createElement(fn,{values:e,setValues:()=>null})},no=I.button`
  white-space: nowrap;
  //display: inline-block;
  ${({selected:e})=>e&&P`
      font-weight: bold;
    `}
`,oo=()=>{var e;const t=null==(e=Se((e=>e.sidebarVisible)))||e,n=Se((e=>e.flows)),o=Se((e=>e.flows.length)),r=Se((e=>e.version)),i=Ce(),l=[t?null:N.createElement(jt,{style:{height:"2em"},key:-1}),N.createElement(no,{key:0,selected:0===r,onClick:()=>i(ge(0))},"Prototyping",n[0]&&":"+Object.keys(n[0].drawflow).length)];for(let s=o-1;s>0;--s)l.push(N.createElement(no,{key:s,selected:s===r,onClick:()=>i(ge(s))},"Version ",s,n[s]&&":"+Object.keys(n[s].drawflow).length));return N.createElement(Hn,null,l)},ro=()=>N.createElement(Qn,null,N.createElement(oo,null),N.createElement(vt,null)),io=()=>{var e;Ce();const t=null==(e=Se((e=>e.sidebarVisible)))||e,n=Se((e=>e.windowConfig.mainId)),o=Se((e=>e.windowConfig.id)),r=Se((e=>e.version));return n===W.templateNodeSettings?N.createElement(N.Fragment,null,N.createElement(Kn,{key:o,id:o})):n===W.nodeSettings?N.createElement(N.Fragment,null,N.createElement(Un,{key:o,id:o})):n===W.mainFlow?N.createElement(ro,{key:r}):n===W.codeEditor?N.createElement(N.Fragment,null,N.createElement("span",{style:{position:"absolute",zIndex:2,backgroundColor:"white",top:-8}},!t&&N.createElement(jt,null)),N.createElement(to,null)):null},lo=()=>{const e=Se((e=>e.windowConfig.sideId));return e===J.flowSettings?N.createElement(en,null):e===J.groupSettings?N.createElement(mn,null):null},so=()=>{const e=Ce();return S.exports.useEffect((()=>{e(re()),e(le()),e(ae()),e(pe())}),[]),N.createElement(eo,null,N.createElement(Rt,null),N.createElement(Zn,null,N.createElement(Lt,null),N.createElement(io,null),N.createElement(lo,null)))};V.render(N.createElement(S.exports.StrictMode,null,N.createElement(A,{store:ke},N.createElement(so,null))),document.getElementById("root"));
